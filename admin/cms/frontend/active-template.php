...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/active-template.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/active-template.php');
}
else
{
