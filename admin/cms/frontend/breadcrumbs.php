...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/frontend/breadcrumbs.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/frontend/breadcrumbs.php');
}
else
{
	//Build breadcurmbs
