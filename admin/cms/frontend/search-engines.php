...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/search-engines.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/search-engines.php');
}
else
{
