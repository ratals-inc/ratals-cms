...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/active-template-includes.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/active-template-includes.php');
}
else
{
