...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/frontend/load-page/sitemap-html-section.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/frontend/load-page/sitemap-html-section.php');
}
else
{
