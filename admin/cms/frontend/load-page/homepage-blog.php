...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/load-page/homepage-blog.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/load-page/homepage-blog.php');
}
else
{
