...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/load-page/categories-blog.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/load-page/categories-blog.php');
}
else
{
