...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/frontend/sidebar-blog-categories.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/frontend/sidebar-blog-categories.php');
}
else
{
