...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/redirect-to-final-url.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/frontend/redirect-to-final-url.php');
}
else
{
