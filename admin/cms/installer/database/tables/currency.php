...
array(
	...
	'currency_type' => array('column_name' => 'currency_type', 'column_type' => 'varchar(3)', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'extra' => '', 'column_key' => '', 'is_nullable' => 'no', 'column_default' => 'USD', 'ordinal_position' => $column_counter++),
	'front_symbol' => array('column_name' => 'front_symbol', 'column_type' => 'varchar(10)', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'extra' => '', 'column_key' => '', 'is_nullable' => 'no', 'column_default' => '', 'ordinal_position' => $column_counter++),
	'back_symbol' => array('column_name' => 'back_symbol', 'column_type' => 'varchar(10)', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'extra' => '', 'column_key' => '', 'is_nullable' => 'no', 'column_default' => '', 'ordinal_position' => $column_counter++),
	'thousand_separator' => array('column_name' => 'thousand_separator', 'column_type' => 'varchar(10)', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'extra' => '', 'column_key' => '', 'is_nullable' => 'no', 'column_default' => '', 'ordinal_position' => $column_counter++),
	'fractional_separator' => array('column_name' => 'fractional_separator', 'column_type' => 'varchar(10)', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'extra' => '', 'column_key' => '', 'is_nullable' => 'no', 'column_default' => '', 'ordinal_position' => $column_counter++),
	'zeros_after_separator' => array('column_name' => 'zeros_after_separator', 'column_type' => 'int', 'character_set_name' => '', 'collation_name' => '', 'extra' => '', 'column_key' => '', 'is_nullable' => 'no', 'column_default' => '0', 'ordinal_position' => $column_counter++),
	'exchange_rate_difference' => array('column_name' => 'exchange_rate_difference', 'column_type' => 'decimal(16,6)', 'character_set_name' => '', 'collation_name' => '', 'extra' => '', 'column_key' => '', 'is_nullable' => 'yes', 'column_default' => '0.000000', 'ordinal_position' => $column_counter++),
