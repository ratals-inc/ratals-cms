...
$parameters['ddos_to_email_name'] = ['Notification Recipient Name', 'ddos_to_email_name', 'ddos-to-email-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', 'Name of person or team the email will be sending to.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['smtp_email_cc'] = ['CC Email Addresses', 'smtp_email_cc', 'smtp-email-cc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";".', '', '{}', $first_last_name, $first_last_name];

$parameters['smtp_email_name'] = ['SMTP Email Name', 'smtp_email_name', 'smtp-email-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Name of person or team the email is from.', '', '{}', $first_last_name, $first_last_name];

$parameters['smtp_email_hostname'] = ['SMTP Email Hostname', 'smtp_email_hostname', 'smtp-email-hostname', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically something like mail.your_domain_name.com', '', '{}', $first_last_name, $first_last_name];
...
$parameters['smtp_email_port'] = ['SMTP Email Port', 'smtp_email_port', 'smtp-email-port', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'int', '', 'Yes', 'No', 'No', '10', '0', 'No', 'No', 'This is typically "587" which is secure or port "25" that is not secure.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sql_injection_to_email_address'] = ['Notification Email Address', 'sql_injection_to_email_address', 'sql-injection-to-email-address', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['user_email_address'] = ['Email', 'user_email_address', 'user-email-address', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['user_email_cc'] = ['CC Email Addresses', 'user_email_cc', 'user-email-cc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";".', '', '{}', $first_last_name, $first_last_name];
