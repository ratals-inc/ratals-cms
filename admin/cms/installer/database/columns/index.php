...
$parameters['admin_fields_lists_parent_code'] = ['Admin Field Lists Parent Code', 'admin_fields_lists_parent_code', 'admin-fields-lists-parent-code', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_fields_lists', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Select the "Admin Field List" this displays under.', '', '{}', $first_last_name, $first_last_name];

$parameters['admin_fields_lists_system_code'] = ['Admin Field Lists', 'admin_fields_lists_system_code', 'admin-fields-lists-system-code', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_fields_lists', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['admin_form_name'] = ['Admin Form Name', 'admin_form_name', 'admin-form-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['admin_name'] = ['Admin Name', 'admin_name', 'admin-name', 'textfield', 'textfieldNoEdit', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['admin_page_level'] = ['Admin Page Level', 'admin_page_level', 'admin-page-level', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_page_level', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['admin_page_system_code'] = ['Admin Page System Code', 'admin_page_system_code', 'admin-page-system-code', 'dropdownId', 'dropdownId', 'Yes', 'Yes', '', 'admin_pages_system_codes', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Select the "Admin Page System Code" that this menu item will link to. This is typically the same as the admin page\'s URL.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['admin_pages_ids'] = ['Admin Pages', 'admin_pages_ids', 'admin-pages-ids', 'textfield', 'permissions', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', 'Select the Admin Page URLs that you would like this permission to be able to access.', '', '{}', $first_last_name, $first_last_name];

$parameters['admin_pages_name'] = ['Name', 'admin_pages_name', 'admin-pages-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(512)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '512', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['analytics_cookie_id'] = ['Analytics Cookie ID', 'analytics_cookie_id', 'analytics-cookie-id', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'char(32)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '32', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['approved_by'] = ['Approved By', 'approved_by', 'approved-by', 'textfield', 'hidden', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['area_served'] = ['Area Served', 'area_served', 'area-served', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Insert area served information with state or country codes like so: US, or US,CA', '', '{}', $first_last_name, $first_last_name];

$parameters['assigned_to'] = ['Assigned To', 'assigned_to', 'assigned-to', 'dropdownId', 'assignedTo', 'Yes', 'Yes', '', 'database_table_names', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['assigned_type'] = ['Assigned Type', 'assigned_type', 'assigned-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'template_files_assigned_type', 'varchar(100)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '100', '0', 'No', 'No', 'Assigned Type is a flag used to identify when custom code should run with a template file. If you plan to add custom logic to this template file, you can use this field to define a variable name that your code will reference. To learn how to make a custom template file load and execute that code, see this tutorial: <a href="https://www.ratals.com/tutorials/customization/setting-up-custom-template-file-code/" target="_blank">here</a>.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['author_job_title'] = ['Author Job Title', 'author_job_title', 'author-job-title', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['author_name'] = ['Author Name', 'author_name', 'author-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['author_photo'] = ['Author Photo', 'author_photo', 'author-photo', 'textfield', 'singleMedia', 'Yes', 'Yes', 'Media ID', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', 'Upload or select the author\'s photo. This image will display on the author\'s profile page and alongside their content.', 'media-center', '{}', $first_last_name, $first_last_name];

$parameters['author_same_as_urls'] = ['Author SameAs URLs', 'author_same_as_urls', 'author-same-as-urls', 'textfield', 'textarea', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', 'Enter the author\'s personal or professional profile URLs, such as their LinkedIn page, personal website, or another trusted source that identifies them. Separate multiple URLs with a comma. These links help search engines connect this person with their existing online presence and recognize them as an established authority in the topics related to their profiles.', '', '{}', $first_last_name, $first_last_name];

$parameters['auto_blocked_email_address'] = ['Email Address for Notices', 'auto_blocked_email_address', 'auto-blocked-email-address', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Note: It will only send you one email when the "Max Pageviews" are met within the "Time Period".', '', '{}', $first_last_name, $first_last_name];

$parameters['auto_blocked_ip_email_me'] = ['When "Max Pageviews" are met within the "Time Period" Set Above, What Should The Software Do', 'auto_blocked_ip_email_me', 'auto-blocked-ip-email-me', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'site_security_email_block_ip', 'varchar(30)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '30', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['auto_complete'] = ['Auto Complete', 'auto_complete', 'auto-complete', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'forms_auto_complete_type', 'varchar(30)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '30', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['auto_generate_canonical_url'] = ['Auto Generate Canonical URL', 'auto_generate_canonical_url', 'auto-generate-canonical-url', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['auto_slide_media'] = ['Auto Slide Media', 'auto_slide_media', 'auto-slide-media', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', 'Select "Yes" if you want the media to auto-slide, or "No" if you do not.', '', '{}', $first_last_name, $first_last_name];

$parameters['available_language'] = ['Available Language', 'available_language', 'available-language', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'View all language code options here: https://developers.google.com/admin-sdk/directory/v1/languages', '', '{}', $first_last_name, $first_last_name];

$parameters['back_symbol'] = ['Back Symbol', 'back_symbol', 'back-symbol', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['blog_sidebar_link_display'] = ['Display Category Link in Blog Sidebar', 'blog_sidebar_link_display', 'blog-sidebar-link-display', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['call_phone_number'] = ['Call Phone Number', 'call_phone_number', 'call-phone-number', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(20)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '20', '0', 'No', 'No', 'Example: 1-888-888-8888', '', '{}', $first_last_name, $first_last_name];

$parameters['call_phone_number_class'] = ['Call Phone Number Class', 'call_phone_number_class', 'call-phone-number-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['call_phone_number_text'] = ['Call Phone Number Text', 'call_phone_number_text', 'call-phone-number-text', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: Call us for a quote:', '', '{}', $first_last_name, $first_last_name];

$parameters['call_phone_number_text_class'] = ['Call Phone Number Text Class', 'call_phone_number_text_class', 'call-phone-number-text-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: call-text-for-quote', '', '{}', $first_last_name, $first_last_name];

$parameters['canonical_url'] = ['Canonical URL', 'canonical_url', 'canonical-url', 'textfield', 'canonicalUrl', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['cf_display_as'] = ['Display As', 'cf_display_as', 'cf-display-as', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'custom_fields_display_as', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['cf_search_as'] = ['Search As', 'cf_search_as', 'cf-search-as', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'custom_fields_search_as', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['child_id_table_name'] = ['Child ID Table Name', 'child_id_table_name', 'child-id-table-name', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['city'] = ['City', 'city', 'city', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['class'] = ['Class', 'class', 'class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Class field is used to identify which custom code should run when this admin page is requested. If you plan to create custom logic for this admin page, you can use this value to match against a variable in your code and determine when that logic should be executed.', '', '{}', $first_last_name, $first_last_name];

$parameters['click_path'] = ['Click Path', 'click_path', 'click-path', 'textfield', 'clickPath', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['collect_analytics_data'] = ['Collect Analytics Data', 'collect_analytics_data', 'collect-analytics-data', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', 'This will collect analytics data within this site\'s database if set to "Yes".', '', '{}', $first_last_name, $first_last_name];

$parameters['color_number'] = ['Color Number', 'color_number', 'color-number', 'textfield', 'colorNumber', 'Yes', 'Yes', '', '0', 'varchar(25)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '25', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['column_name'] = ['Column Name', 'column_name', 'column-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'You can leave this field empty. We will use the "Name" you enter above to create the database "Column Name". If you want to enter the "Column Name" the rules are: use all lowercase letters; use underscores for spaces. Example: new_column_name', '', '{}', $first_last_name, $first_last_name];
...
$parameters['comment'] = ['Comment', 'comment', 'comment', 'textfield', 'textarea', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['comments_block_links'] = ['Automatically Delete Comments with Links', 'comments_block_links', 'comments-block-links', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['content'] = ['Content', 'content', 'content', 'textfield', 'textareaWithEditor', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['content_title'] = ['Content Title / H1', 'content_title', 'content-title', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'The main heading displayed within the page content.', '', '{}', $first_last_name, $first_last_name];

$parameters['cookie_ip_hash'] = ['Cookie IP Hash', 'cookie_ip_hash', 'cookie-ip-hash', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'char(32)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '32', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['copy_template_file'] = ['Copy Template File', 'copy_template_file', 'copy-template-file', 'textfield', 'duplicateTemplateFile', 'Yes', 'Yes', '', '0', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'No', 'Create a copy of this template file so you can customize it without changing the original. After customizing the copy, select it as the Template File on the URL where you want to use it. A copied Page template file will be available for Pages, a Category template file for Categories, and so on.', '', '{}', $first_last_name, $first_last_name];

$parameters['country'] = ['Country', 'country', 'country', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'countries', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['created_by'] = ['Created By', 'created_by', 'created-by', 'textfield', 'createdBy', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['css_class'] = ['CSS Class', 'css_class', 'css-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'If you created a CSS Class for this field, you can add that class here to improve the look and feel of the admin area. Example: if you selected "Date Range" for "Search As" above, you can put date-range in this field and it will make the "from" and "to" dates fields sit next to each in the table view header. If you selected "Media" or "Single Media" enter in media-center.', '', '{}', $first_last_name, $first_last_name];

$parameters['css_class_name'] = ['CSS Class Name', 'css_class_name', 'css-class-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['currency_type'] = ['Currency Type', 'currency_type', 'currency-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'currency_types', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', 'Example: USA dollars uses "USD"', '', '{}', $first_last_name, $first_last_name];

$parameters['custom_field_name'] = ['Custom Field Name', 'custom_field_name', 'custom-field-name', 'textfield', 'customFieldName', 'Yes', 'Yes', '', 'languages', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['custom_fields'] = ['Custom Fields', 'custom_fields', 'custom-fields', 'textfield', 'textfield', 'No', 'Yes', '', '0', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['custom_link'] = ['Custom Link', 'custom_link', 'custom-link', 'textfield', 'customLink', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['data_type'] = ['Data Type', 'data_type', 'data-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_fields_data_type', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['database_table_name'] = ['Database Table Name', 'database_table_name', 'database-table-name', 'dropdownValue', 'databaseTableName', 'Yes', 'Yes', '', 'database_table_names', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['ddos_email_cc'] = ['CC Email Addresses', 'ddos_email_cc', 'ddos-email-cc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";".', '', '{}', $first_last_name, $first_last_name];

$parameters['ddos_email_from'] = ['From Email Address', 'ddos_email_from', 'ddos-email-from', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['ddos_email_from_name'] = ['From Name', 'ddos_email_from_name', 'ddos-email-from-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Name of person or team the email is from.', '', '{}', $first_last_name, $first_last_name];

$parameters['ddos_email_password'] = ['Email Login Password', 'ddos_email_password', 'ddos-email-password', 'textfield', 'password', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '<span class="color-f00"><strong>Important:</strong></span> Leave blank to keep existing value. Also, if you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['ddos_email_server_url'] = ['Email Server URL', 'ddos_email_server_url', 'ddos-email-server-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically something like mail.your_domain_name.com', '', '{}', $first_last_name, $first_last_name];

$parameters['ddos_email_username'] = ['Email Login Username', 'ddos_email_username', 'ddos-email-username', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically the email address you\'re sending from. Note: If you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];

$parameters['ddos_to_name'] = ['To Name', 'ddos_to_name', 'ddos-to-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', 'Name of person or team the email will be sending to.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['default_file'] = ['Default File', 'default_file', 'default-file', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['default_or_custom'] = ['Default Or Custom', 'default_or_custom', 'default-or-custom', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['desktop_media'] = ['Desktop Media', 'desktop_media', 'desktop-media', 'textfield', 'singleMedia', 'Yes', 'Yes', 'Media ID', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', 'media-center', '{}', $first_last_name, $first_last_name];

$parameters['directory_folder_name'] = ['Directory Folder Name', 'directory_folder_name', 'directory-folder-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display'] = ['Display', 'display', 'display', 'dropdownId', 'displayColorSwatch', 'Yes', 'Yes', '', 'custom_field_options_display_color_swatch', 'varchar(20)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '20', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_as'] = ['Display As', 'display_as', 'display-as', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_fields_display_as', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_as_slider'] = ['Display as Slider', 'display_as_slider', 'display-as-slider', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_breadcrumbs'] = ['Display Breadcrumbs', 'display_breadcrumbs', 'display-breadcrumbs', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'No', 'Breadcrumbs are the links at the top of most pages that show the path to the page you\'re on.', '', '{}', $first_last_name, $first_last_name];

$parameters['display_call_phone_number'] = ['Display Call Phone Number', 'display_call_phone_number', 'display-call-phone-number', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(20)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '20', '0', 'No', 'No', 'Example: (888) 888-8888', '', '{}', $first_last_name, $first_last_name];

$parameters['display_contact_info_on_site'] = ['Display Contact Information on Site', 'display_contact_info_on_site', 'display-contact-info-on-site', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['display_in_admin'] = ['Display in Admin', 'display_in_admin', 'display-in-admin', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_last_updated'] = ['Display Last Updated Date', 'display_last_updated', 'display-last-updated', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_pagination'] = ['Display Pagination', 'display_pagination', 'display-pagination', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', 'Choose whether to display pagination (bullets or thumbnails). Select "Yes" to show it or "No" to hide it.', '', '{}', $first_last_name, $first_last_name];

$parameters['display_post_in'] = ['Display Post In', 'display_post_in', 'display-post-in', 'textfield', 'displayPostIn', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_posted_on'] = ['Display Posted On Date', 'display_posted_on', 'display-posted-on', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['display_posts'] = ['Display Blog Posts', 'display_posts', 'display-posts', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'No', 'If you\'re using a blog category template, you can choose whether to display the blog roll (posts assigned to this category) when the page loads on the frontend. Select "No" to hide the blog posts and create a fully custom top-level blog category page.', '', '{}', $first_last_name, $first_last_name];

$parameters['display_sms_phone_number'] = ['Display SMS Phone Number', 'display_sms_phone_number', 'display-sms-phone-number', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(20)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '20', '0', 'No', 'No', 'Example: (888) 888-8888', '', '{}', $first_last_name, $first_last_name];

$parameters['display_text_from_sub_items'] = ['Display Text From Sub Items', 'display_text_from_sub_items', 'display-text-from-sub-items', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['domain'] = ['Domain - TLD', 'domain', 'domain', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['dynamic'] = ['Dynamic', 'dynamic', 'dynamic', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['email'] = ['Email', 'email', 'email', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['email_bcc'] = ['BCC Email Addresses', 'email_bcc', 'email-bcc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";". <span class="color-f00"><strong>Important:</strong></span> Some hosting companies will send BCC emails to imunify/quarantine and they will not be delivered. If you notice BCC emails not being delivered and your domain / hosting IP Address does not have a bad reputation for email spam, contact your hosting company to see if BCC email are being quarantined and not sending from your server.', '', '{}', $first_last_name, $first_last_name];

$parameters['email_cc'] = ['CC Email Addresses', 'email_cc', 'email-cc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";".', '', '{}', $first_last_name, $first_last_name];

$parameters['email_from'] = ['From Email Address', 'email_from', 'email-from', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['email_from_name'] = ['From Name', 'email_from_name', 'email-from-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Name of person or team the email is from.', '', '{}', $first_last_name, $first_last_name];

$parameters['email_password'] = ['Email Login Password', 'email_password', 'email-password', 'textfield', 'password', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '<span class="color-f00"><strong>Important:</strong></span> Leave blank to keep existing value. Also, if you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['email_server_url'] = ['Email Server URL', 'email_server_url', 'email-server-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically something like mail.your_domain_name.com', '', '{}', $first_last_name, $first_last_name];
...
$parameters['email_username'] = ['Email Login Username', 'email_username', 'email-username', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically the email address you\'re sending from. Note: If you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];

$parameters['emailed'] = ['Emailed', 'emailed', 'emailed', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['embed_custom_field'] = ['Embed Custom Field', 'embed_custom_field', 'embed-custom-field', 'textfield', 'embedCustomField', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['embed_form'] = ['Embed Form', 'embed_form', 'embed-form', 'textfield', 'embedForm', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['embed_media'] = ['Embed Media', 'embed_media', 'embed-media', 'textfield', 'embedMedia', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['embed_menu'] = ['Embed Menu', 'embed_menu', 'embed-menu', 'textfield', 'embedMenu', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['embed_slider'] = ['Embed Slider in Template Code', 'embed_slider', 'embed-slider', 'textfield', 'embedSlider', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['event_name'] = ['Event Name', 'event_name', 'event-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['failed_login_attempts_email_address'] = ['Email Address to Send Notice of Failed Login Blocks', 'failed_login_attempts_email_address', 'failed-login-attempts-email-address', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', 'Separate email addresses with ";".', '{}', $first_last_name, $first_last_name];
...
$parameters['failed_login_attempts_email_cc'] = ['CC Email Addresses', 'failed_login_attempts_email_cc', 'failed-login-attempts-email-cc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";".', '', '{}', $first_last_name, $first_last_name];

$parameters['failed_login_attempts_email_from'] = ['From Email Address', 'failed_login_attempts_email_from', 'failed-login-attempts-email-from', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['failed_login_attempts_email_from_name'] = ['From Name', 'failed_login_attempts_email_from_name', 'failed-login-attempts-email-from-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Name of person or team the email is from.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['failed_login_attempts_email_password'] = ['Email Login Password', 'failed_login_attempts_email_password', 'failed-login-attempts-email-password', 'textfield', 'password', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '<span class="color-f00"><strong>Important:</strong></span> Leave blank to keep existing value. Also, if you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['failed_login_attempts_email_server_url'] = ['Email Server URL', 'failed_login_attempts_email_server_url', 'failed-login-attempts-email-server-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically something like mail.your_domain_name.com', '', '{}', $first_last_name, $first_last_name];

$parameters['failed_login_attempts_email_username'] = ['Email Login Username', 'failed_login_attempts_email_username', 'failed-login-attempts-email-username', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically the email address you\'re sending from. Note: If you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];

$parameters['failed_login_attempts_to_name'] = ['To Name', 'failed_login_attempts_to_name', 'failed-login-attempts-to-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', 'Name of person or team the email will be sending to.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['favicon_16px_16px'] = ['Site Favicon (Use .png image 16px x 16px)', 'favicon_16px_16px', 'favicon-16px-16px', 'textfield', 'singleMedia', 'Yes', 'Yes', '', '0', 'varchar(100)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '100', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['favicon_32px_32px'] = ['Site Favicon (Use .png image 32px x 32px)', 'favicon_32px_32px', 'favicon-32px-32px', 'textfield', 'singleMedia', 'Yes', 'Yes', '', '0', 'varchar(100)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '100', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['favicon_180px_180px'] = ['Site Favicon (Use .png image 180px x 180px)', 'favicon_180px_180px', 'favicon-180px-180px', 'textfield', 'singleMedia', 'Yes', 'Yes', '', '0', 'varchar(100)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '100', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['field_section_name'] = ['Field Section Name', 'field_section_name', 'field-section-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['file_code'] = ['File Code', 'file_code', 'file-code', 'textfield', 'fileCode', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '0', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['filename'] = ['Filename', 'filename', 'filename', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Be sure to include your file extension like .php, .html, .htm, .txt, .css, .js. Example: my-file.php', '', '{}', $first_last_name, $first_last_name];

$parameters['filter_attribute_ids'] = ['Filter Attribute IDs', 'filter_attribute_ids', 'filter-attribute-ids', 'textfield', 'hidden', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['financial_field'] = ['Financial Field', 'financial_field', 'financial-field', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', 'When configuring your currency, you specified how many digits appear after the fractional separator. For financial accuracy, fields used in financial reports should always use the full 6 digits (e.g., 0.000000) stored in the database to avoid rounding discrepancies. If this field will be used in financial records, select "Yes" to ensure all 6 digits are displayed and used in calculations for maximum precision.', '', '{}', $first_last_name, $first_last_name];

$parameters['first_name'] = ['First Name', 'first_name', 'first-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['flat_url'] = ['Flat URL', 'flat_url', 'flat-url', 'textfield', 'flatUrl', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['form_auto_complete'] = ['Form Auto Complete', 'form_auto_complete', 'form-auto-complete', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'forms_auto_complete', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['form_field_type'] = ['Form Field Type', 'form_field_type', 'form-field-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'forms_field_type', 'varchar(20)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '20', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['form_fields_ids'] = ['Form Fields IDs', 'form_fields_ids', 'form-fields-ids', 'textfield', 'hidden', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['form_name_class'] = ['Form Name Class', 'form_name_class', 'form-name-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: form-1', '', '{}', $first_last_name, $first_last_name];

$parameters['forms_block_links'] = ['Automatically Mark Form Submissions with Links as Junk', 'forms_block_links', 'forms-block-links', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['forms_frontend_name'] = ['Form Name', 'forms_frontend_name', 'forms-frontend-name', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Form name used to submit this lead.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['fractional_separator'] = ['Fractional Separator', 'fractional_separator', 'fractional-separator', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'currency_fractional_separator', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', 'Example: USA dollars uses a "." to separate dollars and cents', '', '{}', $first_last_name, $first_last_name];

$parameters['front_symbol'] = ['Front Symbol', 'front_symbol', 'front-symbol', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'No', 'Example: USA dollars uses a "$" in front of numbers', '', '{}', $first_last_name, $first_last_name];

$parameters['frontend_name'] = ['Frontend Name', 'frontend_name', 'frontend-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['frontend_name_class'] = ['Frontend Name Class', 'frontend_name_class', 'frontend-name-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: title', '', '{}', $first_last_name, $first_last_name];
...
$parameters['global_url_extension'] = ['Global URL Extension', 'global_url_extension', 'global-url-extension', 'textfield', 'globalUrlExtension', 'Yes', 'Yes', '', '0', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['grid_columns'] = ['Grid Columns', 'grid_columns', 'grid-columns', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'css_grid_columns', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'For templates that include a grid layout, such as blog pages, homepage content, and product category pages, select the number of columns to display. Choosing 1 displays items in a list view, while 2 through 10 display items in a grid with the selected number of columns. Fewer columns create larger content areas and images, while more columns create smaller content areas and images.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['height'] = ['Height', 'height', 'height', 'textfield', 'height', 'Yes', 'Yes', '', '0', 'varchar(25)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '25', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['hierarchy_url'] = ['Hierarchy URL', 'hierarchy_url', 'hierarchy-url', 'textfield', 'hierarchyUrl', 'Yes', 'Yes', '', '0', 'varchar(512)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '512', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['in_form_thank_you'] = ['In Form Thank You', 'in_form_thank_you', 'in-form-thank-you', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Example:  Submitted successfully. Thank you!', '', '{}', $first_last_name, $first_last_name];

$parameters['in_form_thank_you_class'] = ['In Form Thank You Class', 'in_form_thank_you_class', 'in-form-thank-you-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: in-form-thank-you', '', '{}', $first_last_name, $first_last_name];

$parameters['include_in_html_sitemap'] = ['Include In HTML Sitemap', 'include_in_html_sitemap', 'include-in-html-sitemap', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['include_in_site_search'] = ['Display in Site Search', 'include_in_site_search', 'include-in-site-search', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['include_in_xml_sitemap'] = ['Include In XML Sitemap', 'include_in_xml_sitemap', 'include-in-xml-sitemap', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['inner_css_box_styles'] = ['Inner CSS Box Styles', 'inner_css_box_styles', 'inner-css-box-styles', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['install_id'] = ['Install ID', 'install_id', 'install-id', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'char(32)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '32', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['inventory_allow_backorders'] = ['Inventory Allow Backorders', 'inventory_allow_backorders', 'inventory-allow-backorders', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['inventory_assigned'] = ['Inventory Assigned', 'inventory_assigned', 'inventory-assigned', 'textfield', 'hidden', 'Yes', 'Yes', '', '0', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['inventory_attribute_value_ids'] = ['Inventory Attribute Value IDs', 'inventory_attribute_value_ids', 'inventory-attribute-value-ids', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['inventory_track_quantity'] = ['Inventory Track Quantity', 'inventory_track_quantity', 'inventory-track-quantity', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['inventory_url'] = ['Inventory URL', 'inventory_url', 'inventory-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['ip_address'] = ['IP Address', 'ip_address', 'ip-address', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['is_auto_increment'] = ['Is Auto Increment', 'is_auto_increment', 'is-auto-increment', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['is_nullable'] = ['Is Nullable', 'is_nullable', 'is-nullable', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['is_primary_key'] = ['Is Primary Key', 'is_primary_key', 'is-primary-key', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['item_number'] = ['Item Number', 'item_number', 'item-number', 'textfield', 'itemNumber', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['keyword'] = ['Keyword', 'keyword', 'keyword', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['label'] = ['Label', 'label', 'label', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['last_name'] = ['Last Name', 'last_name', 'last-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['lead'] = ['Lead', 'lead', 'lead', 'textfield', 'lead', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['lead_status'] = ['Lead Status', 'lead_status', 'lead-status', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'customer_leads_lead_status', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['license_billing_line_items'] = ['Billing Line Items', 'license_billing_line_items', 'license-billing-line-items', 'textfield', 'licenseBillingLineItems', 'Yes', 'No', '', '0', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['license_key'] = ['License Key', 'license_key', 'license-key', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(128)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '128', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['license_status'] = ['Status', 'license_status', 'license-status', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['license_type'] = ['License Type', 'license_type', 'license-type', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['link_parameters'] = ['Add Link Parameters', 'link_parameters', 'link-parameters', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['link_target'] = ['Link Target', 'link_target', 'link-target', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'links_target_types', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['link_type'] = ['Link Type', 'link_type', 'link-type', 'dropdownId', 'linkType', 'Yes', 'Yes', '', 'urls_link_type', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['manufacturer'] = ['Manufacturer', 'manufacturer', 'manufacturer', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['masked_ip_hash'] = ['Masked IP Address', 'masked_ip_hash', 'masked-ip-address', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'varchar(64)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '64', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['media'] = ['Media', 'media', 'media', 'textfield', 'multipleMedia', 'Yes', 'Yes', 'Media ID', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'No', '', 'media-center', '{}', $first_last_name, $first_last_name];
...
$parameters['media_size'] = ['Media Size', 'media_size', 'media-size', 'textfield', 'hiddenOnAddTextfieldOnEdit', 'Yes', 'Yes', '', '0', 'varchar(20)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '20', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['media_tag'] = ['Media Tag', 'media_tag', 'media-tag', 'textfield', 'mediaTag', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['media_type'] = ['Media Type', 'media_type', 'media-type', 'dropdownValue', 'mediaType', 'Yes', 'Yes', '', 'media_types', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['media_url'] = ['Media URL', 'media_url', 'media-url', 'textfield', 'mediaUrl', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', 'media-library', '{}', $first_last_name, $first_last_name];

$parameters['menu_locations'] = ['Menu Locations', 'menu_locations', 'menu-locations', 'dropdownId', 'checkboxId', 'Yes', 'Yes', '', 'admin_pages_urls_id_as_value', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Select the admin pages you want this menu to display on.', '', '{}', $first_last_name, $first_last_name];

$parameters['menu_type'] = ['Menu Type', 'menu_type', 'menu-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_menu_type', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['meta_description'] = ['Meta Description', 'meta_description', 'meta-description', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['meta_keywords'] = ['Meta Keywords', 'meta_keywords', 'meta-keywords', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['meta_title'] = ['Meta Title', 'meta_title', 'meta-title', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Used for the page title in search results and browser tabs.', '', '{}', $first_last_name, $first_last_name];

$parameters['microsoft_advertising_tag_id'] = ['Microsoft Advertising Tag ID', 'microsoft_advertising_tag_id', 'microsoft-advertising-tag-id', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(30)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '30', '0', 'No', 'No', 'When you enter a Microsoft Advertising account number here, the site will start pushing purchase values to Microsoft Ads.', '', '{}', $first_last_name, $first_last_name];

$parameters['mobile_media'] = ['Mobile Media', 'mobile_media', 'mobile-media', 'textfield', 'singleMedia', 'Yes', 'Yes', 'Media ID', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'No', '', 'media-center', '{}', $first_last_name, $first_last_name];

$parameters['name'] = ['Name', 'name', 'name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['name_class'] = ['Frontend Name Class', 'name_class', 'name-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: text', '', '{}', $first_last_name, $first_last_name];

$parameters['name_in_title_tag'] = ['Add Site Name In Title Tag', 'name_in_title_tag', 'name-in-title-tag', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['new_url'] = ['New URL', 'new_url', 'new-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Do not add a slash or extension (i.e. html) to the front or back of the URL path. Example: category-name/new-product', '', '{}', $first_last_name, $first_last_name];
...
$parameters['notes'] = ['Notes', 'notes', 'notes', 'textfield', 'textarea', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_message'] = ['Notice Message', 'notice_message', 'notice-message', 'textfield', 'textareaWithEditor', 'Yes', 'Yes', '', '0', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_software_version'] = ['Notice Software Version', 'notice_software_version', 'notice-software-version', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_subject'] = ['Notice Subject', 'notice_subject', 'notice-subject', 'textfield', 'textfield', 'Yes', 'No', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_update_software'] = ['Notice Update Software', 'notice_update_software', 'notice-update-software', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_upgrade_from'] = ['Notice Upgrade From', 'notice_upgrade_from', 'notice-upgrade-from', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_upgrade_to'] = ['Notice Upgrade To', 'notice_upgrade_to', 'notice-upgrade-to', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['notice_url'] = ['Notice URL', 'notice_url', 'notice-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(512)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '512', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['old_url'] = ['Old URL', 'old_url', 'old-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Do not add a slash or extension (i.e. html) to the front or back of the URL path. Example: category-name/old-product', '', '{}', $first_last_name, $first_last_name];

$parameters['one_record'] = ['Single Page Form', 'one_record', 'one-record', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', 'Select "Yes" if this admin page will be a single-page form. Select "No" if the page will contain multiple rows of records.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['option_data'] = ['Option Data', 'option_data', 'option-data', 'textfield', 'optionData', 'Yes', 'Yes', '', 'languages', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['original_media'] = ['Original Media', 'original_media', 'original-media', 'dropdownValue', 'originalMedia', 'Yes', 'No', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['outter_css_box_styles'] = ['Outter CSS Box Styles', 'outter_css_box_styles', 'outter-css-box-style', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['pageview_hash'] = ['Pageview Hash', 'pageview_hash', 'pageview-hash', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'char(32)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '32', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['pageview_url'] = ['Pageview URL', 'pageview_url', 'pageview-url', 'textfield', 'text', 'Yes', 'No', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['parent_id_table_name'] = ['Parent ID Table Name', 'parent_id_table_name', 'parent-id-table-name', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['password'] = ['Password', 'password', 'password', 'textfield', 'passwordAndConfirmPassword', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '<span class="color-f00"><strong>Important:</strong></span> Leave blank to keep existing value.', '', '{}', $first_last_name, $first_last_name];

$parameters['path_level'] = ['URL Sub Items', 'path_level', 'path-level', 'textfield', 'hidden', 'No', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['phone_number_ext'] = ['Phone Number Ext', 'phone_number_ext', 'phone-number-ext', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['placeholder'] = ['Placeholder', 'placeholder', 'placeholder', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['postal_code'] = ['Postal Code', 'postal_code', 'postal-code', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(30)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '30', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['redirect_to_opposite_url'] = ['Redirect To Opposite URL', 'redirect_to_opposite_url', 'redirect-to-opposite-url', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['redirect_type'] = ['Redirect Type', 'redirect_type', 'redirect-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'urls_redirect_types', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['referer_source'] = ['Referrer Source', 'referer_source', 'referer-source', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(100)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '100', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['referer_url'] = ['Referrer URL', 'referer_url', 'referer-url', 'textfield', 'text', 'Yes', 'No', '', '0', 'varchar(512)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '512', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['required'] = ['Required', 'required', 'required', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['required_mysql_version'] = ['Required MySQL Version', 'required_mysql_version', 'required-mysql-version', 'textfield', 'textfield', 'Yes', 'No', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['required_php_version'] = ['Required PHP Version', 'required_php_version', 'required-php-version', 'textfield', 'textfield', 'Yes', 'No', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['reset_expires'] = ['Reset Expires', 'reset_expires', 'reset-expires', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['reset_selector'] = ['Reset Selector', 'reset_selector', 'reset-selector', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['reset_token'] = ['Reset Token', 'reset_token', 'reset-token', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['search_as'] = ['Search As', 'search_as', 'search-as', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'admin_fields_search_as', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['seo_keyword'] = ['SEO Keyword', 'seo_keyword', 'seo-keyword', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['site_email'] = ['Site Email Address', 'site_email', 'site-email', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Be sure to enter an email address for this domain name that you\'re editing. Not doing so will make any emails you send out, from the admin area, go to the recipient\'s junk inbox.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['site_logo_media_id'] = ['Site Logo Media ID', 'site_logo_media_id', 'site-logo-media-id', 'textfield', 'singleMedia', 'Yes', 'Yes', '', '0', 'varchar(100)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '100', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sms_phone_number'] = ['SMS Phone Number', 'sms_phone_number', 'sms-phone-number', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(30)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '30', '0', 'No', 'No', 'Example: 1-888-888-8888', '', '{}', $first_last_name, $first_last_name];

$parameters['sms_phone_number_class'] = ['SMS Phone Number Class', 'sms_phone_number_class', 'sms-phone-number-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['sms_phone_number_text'] = ['SMS Phone Number Text', 'sms_phone_number_text', 'sms-phone-number-text', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example:  | Text us for a quote:', '', '{}', $first_last_name, $first_last_name];

$parameters['sms_phone_number_text_class'] = ['SMS Phone Number Text Class', 'sms_phone_number_text_class', 'sms-phone-number-text-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: call-text-for-quote', '', '{}', $first_last_name, $first_last_name];

$parameters['sort'] = ['Sort', 'sort', 'sort', 'textfield', 'hidden', 'Yes', 'Yes', '', '0', 'int', '', 'Yes', 'No', 'No', '0', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['sort_or_dragdrop'] = ['Sort or Drag & Drop', 'sort_or_dragdrop', 'sort-or-dragdrop', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'sort_or_drag_and_drop', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', 'If the database table includes a sort column, choose whether the record order should be managed using Sorting or Drag & Drop.', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_email_address'] = ['Email Address for SQL Injection Notices', 'sql_injection_email_address', 'sql-injection-email-address', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sql_injection_email_cc'] = ['CC Email Addresses', 'sql_injection_email_cc', 'sql-injection-email-cc', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Separate email addresses with ";".', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_email_from'] = ['From Email Address', 'sql_injection_email_from', 'sql-injection-email-from', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_email_from_name'] = ['From Name', 'sql_injection_email_from_name', 'sql-injection-email-from-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Name of person or team the email is from.', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_email_me'] = ['Email Me When It Seems Like Someone Might Be Trying to do SQL Injection', 'sql_injection_email_me', 'sql-injection-email-me', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', 'If we notice any POST attempts with SQL words like UNION, DELETE, UPDATE, ALTER, etc., we will email you the details of what they are trying to do.', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_email_password'] = ['Email Login Password', 'sql_injection_email_password', 'sql-injection-email-password', 'textfield', 'password', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '<span class="color-f00"><strong>Important:</strong></span> Leave blank to keep existing value. Also, if you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sql_injection_email_server_url'] = ['Email Server URL', 'sql_injection_email_server_url', 'sql-injection-email-server-url', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically something like mail.your_domain_name.com', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_email_username'] = ['Email Login Username', 'sql_injection_email_username', 'sql-injection-email-username', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'This is typically the email address you\'re sending from. Note: If you are running email through a connector or relay and have whitelisted this sites IP, leave the username/password empty.', '', '{}', $first_last_name, $first_last_name];

$parameters['sql_injection_to_name'] = ['To Name', 'sql_injection_to_name', 'sql-injection-to-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(50)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '50', '0', 'No', 'No', 'Name of person or team the email will be sending to.', '', '{}', $first_last_name, $first_last_name];
...
$parameters['state'] = ['State / Province / Region', 'state', 'state', 'textfield', 'textfield', 'Yes', 'Yes', '', '', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['street_address'] = ['Street Address', 'street_address', 'street-address', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['street_address_1'] = ['Street Address 1', 'street_address_1', 'street-address-1', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['street_address_2'] = ['Street Address 2', 'street_address_2', 'street-address-2', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sub_items_code'] = ['Sub Items Code', 'sub_items_code', 'sub-items-code', 'textfield', 'textarea', 'Yes', 'Yes', '', '0', 'longtext', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '2147483647', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sub_items_load_template_include_file'] = ['Sub Items Load Template Include File', 'sub_items_load_template_include_file', 'sub-items-load-template-include-file', 'template', 'template', 'Yes', 'Yes', '', 'templates_files_list_of_all_files', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['sub_items_type'] = ['Sub Items Type', 'sub_items_type', 'sub-items-type', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(25)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '25', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['sub_page'] = ['Sub Page', 'sub_page', 'sub-page', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'No', 'Will this admin page have Sub Pages under it? Select "Yes" if you are creating a URL such as "content/menus/menu_items", content/menus/menu_items/add, or content/menus/menu_items/edit', '', '{}', $first_last_name, $first_last_name];

$parameters['sub_products_ids'] = ['Sub Products IDs', 'sub_products_ids', 'sub-products-ids', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['sub_text'] = ['Sub Text', 'sub_text', 'sub-text', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: We hate spam just as much as you do. We will not sell your information to any third parties. We will ONLY use the information you provide to give you your free quote.', '', '{}', $first_last_name, $first_last_name];

$parameters['sub_text_class'] = ['Sub Text Class', 'sub_text_class', 'sub-text-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: note', '', '{}', $first_last_name, $first_last_name];
...
$parameters['submit_button_text'] = ['Submit Button Text', 'submit_button_text', 'submit-button-text', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'Example: REQUEST QUOTE', '', '{}', $first_last_name, $first_last_name];

$parameters['submit_button_text_class'] = ['Submit Button Text Class', 'submit_button_text_class', 'submit-button-text-class', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'Example: button', '', '{}', $first_last_name, $first_last_name];
...
$parameters['submitted_from_url'] = ['Submitted From URL', 'submitted_from_url', 'submitted-from-url', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['svg_path'] = ['SVG Icon Path', 'svg_path', 'svg-path', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['system_code'] = ['System Code', 'system_code', 'system-code', 'textfield', 'textfield', 'Yes', 'No', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', 'In most cases, leave this blank. System Code is used by developers to identify records and create relationships between them. If set when creating a record, it cannot be changed later. When creating a System Code, use lowercase letters and underscores instead of spaces, typically based on the name of the record. Example: my_new_created_name', '', '{}', $first_last_name, $first_last_name];
...
$parameters['table_of_contents'] = ['Table of Contents', 'table_of_contents', 'table-of-contents', 'textfield', 'textarea', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'No', 'Table of Contents setup code: &lt;div class=&quot;table-of-contents&quot;&gt;&lt;div class=&quot;title&quot;&gt;Table of Contents&lt;/div&gt;&lt;ul&gt;&lt;li&gt;<embed>&</embed>#x276F;<embed>&</embed>nbsp; &lt;a href="#name-1"&gt;Name 1&lt;/a&gt;&lt;/li&gt;&lt;/ul&gt;&lt;/div&gt;', '', '{}', $first_last_name, $first_last_name];

$parameters['table_to_export'] = ['Table To Export', 'table_to_export', 'table-to-export', 'tableName', 'tableName', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['tablet_media'] = ['Tablet Media', 'tablet_media', 'tablet-media', 'textfield', 'singleMedia', 'Yes', 'Yes', 'Media ID', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'No', '', 'media-center', '{}', $first_last_name, $first_last_name];

$parameters['template'] = ['Template', 'template', 'template', 'template', 'template', 'Yes', 'Yes', '', 'templates_files_list_of_all_files', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '<span class="color-f00"><strong>Understanding Templates:</strong></span> Templates provide a default layout, while Sub Items let you customize and build within that layout. Add a Sub Item using the tab above to see where it appears in the selected template, then use Sub Items to build and arrange the page as needed. To change where Sub Items appear, copy the template and move the Sub Items placement code within your copied template.', '', '{}', $first_last_name, $first_last_name];

$parameters['template_type'] = ['Template Type', 'template_type', 'template-type', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'templates_types', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['title'] = ['Title', 'title', 'title', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['updated_by'] = ['Updated By', 'updated_by', 'updated-by', 'textfield', 'updatedBy', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['url_404'] = ['404 URL', 'url_404', 'url-404', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(512)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '512', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['url_extension'] = ['URL Extension', 'url_extension', 'url-extension', 'textfield', 'urlExtension', 'Yes', 'Yes', '', '0', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['url_name'] = ['URL Name', 'url_name', 'url-name', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(255)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '255', '0', 'No', 'Yes', 'You can leave this field empty. We will use the "Name" you enter above to create the database "URL Name". If you want to enter the "URL Name" the rules are: use all lowercase letters; use dashes for spaces. Example: new-url-name', '', '{}', $first_last_name, $first_last_name];
...
$parameters['url_structure'] = ['URL Structure', 'url_structure', 'url-structure', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'site_settings_url_structure', 'varchar(10)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '10', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['user_email'] = ['User Email', 'user_email', 'user-email', 'textfield', 'text', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['value_ids'] = ['Value IDs', 'value_ids', 'value-ids', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['values'] = ['Values', 'values', 'values', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'text', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '65535', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
...
$parameters['wait'] = ['Wait', 'wait', 'wait', 'textfield', 'textfield', 'Yes', 'Yes', '', '0', 'varchar(5)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '5', '0', 'No', 'No', '', '', '{}', $first_last_name, $first_last_name];

$parameters['width'] = ['Width', 'width', 'width', 'textfield', 'width', 'Yes', 'Yes', '', '0', 'varchar(25)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '25', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];

$parameters['www_in_url'] = ['www in URL', 'www_in_url', 'www-in-url', 'dropdownValue', 'dropdownValue', 'Yes', 'Yes', '', 'yes_no', 'varchar(3)', 'CHARACTER SET `utf8mb4` COLLATE `utf8mb4_unicode_ci`', 'No', 'No', 'No', '3', '0', 'No', 'Yes', '', '', '{}', $first_last_name, $first_last_name];
