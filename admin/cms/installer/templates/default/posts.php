...
<?php } ?>
<?php if(isset($data_array['media_data'][0]['path_url']) && !empty($data_array['media_data'][0]['path_url'])) { ?>
<meta property="og:image" content="<?php echo $domain.'/'.$data_array['media_data'][0]['path_url']; ?>" />
<?php } ?>
