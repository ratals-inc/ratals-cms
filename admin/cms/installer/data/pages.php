...
$column_names = '`id`, `site_id`, `urls_id`, `number_of_posts`, `number_of_sitemap_results`, `custom_fields`, `updated_date`, `updated_by`, `created_date`, `created_by`';
$placeholders = '?,?,?,?,?,?,UTC_TIMESTAMP(),?,UTC_TIMESTAMP(),?';

$parameters = array();

//Homepage
$parameters[] = [$_SESSION['install_ids'][$site_id]['homepage_id'] ?? NULL, $site_id, $_SESSION['install_ids'][$site_id]['homepage_url_id'] ?? 0, NULL, NULL, '{}', $first_last_name, $first_last_name];

//Blog
$parameters[] = [$_SESSION['install_ids'][$site_id]['blog_page_id'] ?? NULL, $site_id, $_SESSION['install_ids'][$site_id]['blog_page_url_id'] ?? 0, NULL, NULL, '{}', $first_last_name, $first_last_name];
