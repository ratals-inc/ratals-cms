...
$parameters[] = ['Custom Fields', 'custom-fields', '', 'custom-fields/edit', 'custom-field-options', '', '', '', '', '', 'table', 'custom_fields', '', '', '', 'custom_fields_options', 'custom_fields_id', '0', 'custom-fields', '1', 'No', 'sort', 'Yes', 'No', 'No', '', 'delete-custom-fields', 'custom-fields', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
...
$parameters[] = ['Global Custom Fields', 'custom-fields/global-custom-fields', '', '', '', '', '', 'custom-fields/global-custom-fields', '', '', 'edit', 'custom_fields_global', '', '', '', '', '', '', 'custom-fields/global-custom-fields', '1', 'No', 'sort', 'No', 'Yes', 'No', '', '', 'global-custom-fields', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
...
$parameters[] = ['Media', 'media', '', 'media/edit', '', '', '', '', '', '', 'table', 'media', '', '', '', '', '', '', 'media', '1', 'No', 'sort', 'Yes', 'No', 'No', '', 'delete-media', 'media', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
...
$parameters[] = ['Form Fields', 'website/form-fields', '', 'website/form-fields/edit', 'website/form-field-options', '', '', '', '', '', 'table', 'form_fields', '', '', '', 'form_values', 'form_fields_id', '0', 'website/form-fields', '1', 'No', 'sort', 'Yes', 'No', 'No', '', 'delete-form-fields', 'form-fields', 'Save', 'submit', '{}', $first_last_name, $first_last_name];

$parameters[] = ['Add Form Field', 'website/form-fields/add', '', '', '', '', '', 'website/form-fields', '', '', 'add', 'form_fields', '', '', '', 'form_values', 'form_fields_id', '0', 'website/form-fields/add', '1', 'No', 'sort', 'Yes', 'No', 'No', '', '', 'add-form-field', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
...
$parameters[] = ['Add Form', 'website/forms/add', '', '', '', '', '', 'website/forms', '', '', 'add', 'forms', '', '', '', '', '', '', 'website/forms/add', '1', 'No', 'sort', 'Yes', 'No', 'No', '', '', 'add-form', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
...
$parameters[] = ['Form Fields', 'website/forms/form-fields', '', '', '', '', '', 'website/forms/form-fields', 'website/forms', '', 'static', 'forms', '', '', '', '', '', 'website/forms', 'website/forms/form-fields', '1', 'No', 'sort', 'Yes', 'No', 'No', 'form_fields_assigned', '', 'form-fields-assigned', 'Save', 'submit', '{}', $first_last_name, $first_last_name];

$parameters[] = ['Form Media Swatches', 'website/forms/media-swatches', '', '', '', '', '', 'website/forms/media-swatches', 'website/forms', '', 'static', 'form_media', 'id', 'forms', 'id', '', '', 'website/forms', 'website/forms/media-swatches', '1', 'No', 'sort', 'Yes', 'No', 'No', 'form_media_swatches', '', 'form-media-swatches', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
...
$parameters[] = ['Edit Menu', 'website/menus/edit', '', '', '', '', 'website/menu-items', 'website/menus', 'website/menus', '', 'edit', 'menus', '', '', '', 'menu_items', 'menus_id', 'website/menus', 'website/menus/edit', '1', 'No', 'sort', 'No', 'No', 'No', '', '', 'edit-menu', 'Save', 'submit', '{}', $first_last_name, $first_last_name];
