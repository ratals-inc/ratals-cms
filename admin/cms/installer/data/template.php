...
$parameters = [NULL, $site_id, $template_status, $template_name, 0, ($_SESSION['template-screenshot-default.png'] ?? 1).'~||~Template Screenshot', $template_to_install, '', $install_update_username, $install_update_username];
