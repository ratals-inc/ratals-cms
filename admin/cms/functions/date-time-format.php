...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/functions/date-time-format.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/functions/date-time-format.php');
}
else
{
