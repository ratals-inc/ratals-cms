...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/change-active.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/change-active.php');
}
else
{
