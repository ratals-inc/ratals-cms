...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/password-validation.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/password-validation.php');
}
else
{
