...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/functions/device-viewport.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/functions/device-viewport.php');
}
else
{
