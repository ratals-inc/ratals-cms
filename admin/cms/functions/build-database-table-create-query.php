...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/build-database-table-create-query.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/build-database-table-create-query.php');
}
else
{
