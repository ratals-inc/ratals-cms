...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/update-leads-from-junk-to-active.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/update-leads-from-junk-to-active.php');
}
else
{
