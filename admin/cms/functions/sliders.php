...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/sliders.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/functions/sliders.php');
}
else
{
	//Select slider data
				...
				if(!empty($slider_items))
				{
					...
					foreach($slider_items as $sql_sliders_rows)
					{
						...
						if(!empty($sql_slider_items_pages_url_rows) && empty($sql_sliders_rows["custom_link"]) && empty($sql_slider_items_pages_url_rows["custom_link"]))
						{
							...
							{
								$sql_sliders_rows["slider_url"] = $domain."/".$sql_slider_items_pages_url_rows["hierarchy_url"].$silder_end_url_with;
							...
							{
								$sql_sliders_rows["slider_url"] = $domain."/".$sql_slider_items_pages_url_rows["flat_url"].$silder_end_url_with;
							...
							{
								$sql_sliders_rows["slider_url"] = $domain."/";
