...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/functions/admin-field-lists-swap.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/functions/admin-field-lists-swap.php');
}
else
{
