...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/customFieldName.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/customFieldName.php');
}
else
{
