...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/dropdownId.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/dropdownId.php');
}
else
{
