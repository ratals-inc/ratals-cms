...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/optionData.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/optionData.php');
}
else
{
