...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/template.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/template.php');
}
else
{
