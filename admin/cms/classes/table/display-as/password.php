...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/password.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/password.php');
}
else
{
