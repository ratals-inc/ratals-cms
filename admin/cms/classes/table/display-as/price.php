...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/price.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/display-as/price.php');
}
else
{
