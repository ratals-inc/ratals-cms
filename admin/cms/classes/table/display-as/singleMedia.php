...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/table/display-as/singleMedia.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/table/display-as/singleMedia.php');
}
else
{
	if(!class_exists('singleMediaTda'))
	{
		class singleMediaTda
		{
			public function singleMediaTda($sql_custom_fields_rows, $sql_account_columns_active)
			{
				//Media
		...
		$class_singleMediaTda = new singleMediaTda();
	}
	
	$class_singleMediaTda->singleMediaTda($sql_custom_fields_rows, $sql_account_columns_active);
}