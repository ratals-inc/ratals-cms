...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/cf-display-as/multipleMedia.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/cf-display-as/multipleMedia.php');
}
else
{
