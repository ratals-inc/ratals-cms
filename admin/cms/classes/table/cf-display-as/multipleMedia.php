...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/table/cf-display-as/multipleMedia.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/table/cf-display-as/multipleMedia.php');
}
else
{
	if(!class_exists('multipleMediaTcfda'))
	{
		class multipleMediaTcfda
		{
			public function multipleMediaTcfda($sql_custom_fields_rows, $sql_account_columns_active)
			{
		...
		$class_multipleMediaTcfda = new multipleMediaTcfda();
	}
	
	$class_multipleMediaTcfda->multipleMediaTcfda($sql_custom_fields_rows, $sql_account_columns_active);
}