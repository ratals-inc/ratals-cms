...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/cf-display-as/swatch.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/cf-display-as/swatch.php');
}
else
{
