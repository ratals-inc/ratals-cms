...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/cf-display-as/boxes.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/cf-display-as/boxes.php');
}
else
{
