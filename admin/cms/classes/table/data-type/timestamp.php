...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/data-type/timestamp.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/data-type/timestamp.php');
}
else
{
