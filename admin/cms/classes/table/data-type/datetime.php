...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/data-type/datetime.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/data-type/datetime.php');
}
else
{
