...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/tablet_media.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/tablet_media.php');
}
else
{
