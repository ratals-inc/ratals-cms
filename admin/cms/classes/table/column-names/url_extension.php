...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/url_extension.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/url_extension.php');
}
else
{
