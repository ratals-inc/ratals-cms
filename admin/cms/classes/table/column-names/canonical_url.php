...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/canonical_url.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/canonical_url.php');
}
else
{
