...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/status.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/table/column-names/status.php');
}
else
{
