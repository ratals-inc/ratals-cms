...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/field_type.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/field_type.php');
}
else
{
