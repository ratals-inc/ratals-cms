...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/option_data.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/option_data.php');
}
else
{
