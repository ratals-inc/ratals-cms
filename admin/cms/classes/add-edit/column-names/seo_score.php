...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/seo_score.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/seo_score.php');
}
else
{
