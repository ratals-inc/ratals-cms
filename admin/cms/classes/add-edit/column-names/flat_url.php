...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/flat_url.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/flat_url.php');
}
else
{
