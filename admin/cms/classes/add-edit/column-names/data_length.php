...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/data_length.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/column-names/data_length.php');
}
else
{
