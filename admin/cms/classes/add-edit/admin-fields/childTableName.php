...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/childTableName.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/childTableName.php');
}
else
{
	if(!class_exists('childTableNameAeaf'))
	{
		class childTableNameAeaf
		{
		...
		$class_childTableNameAeaf = new childTableNameAeaf();
	}
	
	$class_childTableNameAeaf->childTableNameAeaf($table_name, $admin_field, $field_value, $errors, $post_values);
}