...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/originalMediaId.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/originalMediaId.php');
}
else
{
	if(!class_exists('originalMediaIdAeaf'))
	{
		class originalMediaIdAeaf
		{
			public function originalMediaIdAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values)
			{
		...
		$class_originalMediaIdAeaf = new originalMediaIdAeaf();
	}
	
	$class_originalMediaIdAeaf->originalMediaIdAeaf($table_name, $admin_field, $field_value, $errors, $post_values);
}