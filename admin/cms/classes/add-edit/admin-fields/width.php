...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/width.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/width.php');
}
else
{
if(!class_exists('widthAeaf'))
	{
		class widthAeaf
		{
			public function widthAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values)
			{
		...
		$class_widthAeaf = new widthAeaf();
	}
	
	$class_widthAeaf->widthAeaf($table_name, $admin_field, $field_value, $errors, $post_values);
}