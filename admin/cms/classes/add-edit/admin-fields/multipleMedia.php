		...
		class multipleMediaAeaf
		{
			public function multipleMediaAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values, $domain)
			{
				...
				else
				{
					...
					if($_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/pages/add' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/pages/edit' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/categories/add' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/categories/edit' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/posts/add' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/posts/edit' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/authors/add' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/authors/edit')
					{
						$field_label = 'Featured Media';
						$field_notes = 'Select the media that represents this page in areas such as listings, archives, and site search. The first media selected will be used in these locations. Additional media added here is for reference within the admin. Featured Media does not automatically display within the page content. To add media to the page content, click where you want it to appear within the text editor and select your media. A media tag will be added to the editor content area and automatically converted to the selected media when the page loads.';
					}
					elseif($_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/products/add' || $_SESSION['admin_url'] == INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/website/products/edit')
					{
						$field_label = 'Product Media';
						$field_notes = 'Select the primary media for this product. The first media selected will be used in areas such as product listings, categories, archives, and site search. Additional media will be displayed on the product page when the selected inventory item does not have its own media assigned.';
					}
					else
					{
