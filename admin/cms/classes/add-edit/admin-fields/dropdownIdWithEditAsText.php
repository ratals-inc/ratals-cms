...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/dropdownIdWithEditAsText.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/dropdownIdWithEditAsText.php');
}
else
{
	if(!class_exists('dropdownIdWithEditAsTextAeaf'))
	{
		class dropdownIdWithEditAsTextAeaf
		{
			public function dropdownIdWithEditAsTextAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values, $column_data_dynamic_lists, $label_names, $current_values)
			{
		...
		$class_dropdownIdWithEditAsTextAeaf = new dropdownIdWithEditAsTextAeaf();
	}
	
	$class_dropdownIdWithEditAsTextAeaf->dropdownIdWithEditAsTextAeaf($table_name, $admin_field, $field_value, $errors, $post_values, $column_data_dynamic_lists, $label_names, $current_values);
}