...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/dropdownId.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/dropdownId.php');
}
else
{
	if(!class_exists('dropdownIdAeaf'))
	{
		class dropdownIdAeaf
		{
			public function dropdownIdAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values, $current_values)
			{
		...
		$class_dropdownIdAeaf = new dropdownIdAeaf();
	}
	
	$class_dropdownIdAeaf->dropdownIdAeaf($table_name, $admin_field, $field_value, $errors, $post_values, $current_values);
}