...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/originalMedia.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/originalMedia.php');
}
else
{
	if(!class_exists('originalMediaAeaf'))
	{
		class originalMediaAeaf
		{
			public function originalMediaAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values, $current_values)
			{
		...
		$class_originalMediaAeaf = new originalMediaAeaf();
	}
	
	$class_originalMediaAeaf->originalMediaAeaf($table_name, $admin_field, $field_value, $errors, $post_values, $current_values);
}