...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/dropdownValue.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/dropdownValue.php');
}
else
{
	if(!class_exists('dropdownValueAeaf'))
	{
		class dropdownValueAeaf
		{
			public function dropdownValueAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values, $current_values)
			{
		...
		$class_dropdownValueAeaf = new dropdownValueAeaf();
	}
	
	$class_dropdownValueAeaf->dropdownValueAeaf($table_name, $admin_field, $field_value, $errors, $post_values, $current_values);
}