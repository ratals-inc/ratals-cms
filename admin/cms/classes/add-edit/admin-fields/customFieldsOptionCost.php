...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/customFieldsOptionCost.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/classes/add-edit/admin-fields/customFieldsOptionCost.php');
}
else
{
	if(!class_exists('customFieldsOptionCostAeaf'))
	{
		class customFieldsOptionCostAeaf
		{
			public function customFieldsOptionCostAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values)
			{
		...
		$class_customFieldsOptionCostAeaf = new customFieldsOptionCostAeaf();
	}
	
	$class_customFieldsOptionCostAeaf->customFieldsOptionCostAeaf($table_name, $admin_field, $field_value, $errors, $post_values);
}