...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/admin-fields/text.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/admin-fields/text.php');
}
else
{
	if(!class_exists('licenseBillingLineItemsAeaf'))
	{
		class licenseBillingLineItemsAeaf
		{
			public function licenseBillingLineItemsAeaf($table_name, $admin_field, $field_value, &$errors, &$post_values, $column_data_dynamic_lists, $label_names)
			{
				$display_field_value = '';
		...
		$class_licenseBillingLineItemsAeaf = new licenseBillingLineItemsAeaf();
	}
	
	$class_licenseBillingLineItemsAeaf->licenseBillingLineItemsAeaf($table_name, $admin_field, $field_value, $errors, $post_values, $column_data_dynamic_lists, $label_names);
}