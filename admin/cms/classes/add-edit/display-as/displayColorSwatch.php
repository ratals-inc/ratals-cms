...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/display-as/displayColorSwatch.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/display-as/displayColorSwatch.php');
}
else
{
