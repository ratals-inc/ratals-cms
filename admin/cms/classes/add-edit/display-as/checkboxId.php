...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/display-as/checkboxId.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/display-as/checkboxId.php');
}
else
{
