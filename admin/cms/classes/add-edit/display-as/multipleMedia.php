...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/display-as/multipleMedia.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/classes/add-edit/display-as/multipleMedia.php');
}
else
{
