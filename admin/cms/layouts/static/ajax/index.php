...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/ajax/index.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/ajax/index.php');
}
else
{
}
