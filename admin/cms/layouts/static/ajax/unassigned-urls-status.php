...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/ajax/unassigned-urls-status.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/ajax/unassigned-urls-status.php');
}
else
{
