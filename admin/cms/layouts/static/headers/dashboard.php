...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/headers/dashboard.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/headers/dashboard.php');
}
else
{
