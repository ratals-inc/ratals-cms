...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/headers/analytics-unique-visitors.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/headers/analytics-unique-visitors.php');
}
else
{
