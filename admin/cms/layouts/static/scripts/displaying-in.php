...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/scripts/displaying-in.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/scripts/displaying-in.php');
}
else
{
