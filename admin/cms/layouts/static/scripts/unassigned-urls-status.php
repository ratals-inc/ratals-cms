...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/scripts/unassigned-urls-status.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/static/scripts/unassigned-urls-status.php');
}
else
{
