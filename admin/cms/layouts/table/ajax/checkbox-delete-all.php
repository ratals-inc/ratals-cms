...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/ajax/checkbox-delete-all.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/ajax/checkbox-delete-all.php');
}
else
{
}