...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/ajax/index.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/ajax/index.php');
}
else
{
}
