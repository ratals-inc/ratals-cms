...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/scripts/sort-table-columns.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/scripts/sort-table-columns.php');
}
else
{
?>
