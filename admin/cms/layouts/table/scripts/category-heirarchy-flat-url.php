...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/scripts/category-heirarchy-flat-url.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/table/scripts/category-heirarchy-flat-url.php');
}
else
{
?>
