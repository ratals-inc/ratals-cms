...
else
{
	...
	//die;
	include_once 'includes/insert-data.php';
?>
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <div class="right">
      ...
      <div class="edit-wrapper">
        ...
        <?php if(empty($errors) && isset($_GET['created']) && $_GET['created'] == 'success') { echo '<div class="changes-saved">Created successfully.</div>'; } ?>
        ...
        <?php if($status_lock_insert_update_delete == 'Yes') { echo '<div class="changes-error">Locked from adding as status is <strong>'.$admin_page_status.'</strong>.</div>'; }?>
