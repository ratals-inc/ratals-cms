...
?>
    ...
    ?>
      ...
      <div class="edit-wrapper">
        ...
        <?php if(empty($errors) && isset($_GET['q-and-a-admin-user-email']) && $_GET['q-and-a-admin-user-email'] == 'no') { echo '<div class="changes-error">Oops! You need to add an "email address" to your admin user profile as well as fill in your SMTP Email Server information to email this customer. You can do that <a href="'.INSTALLATION_URL_PATH.'/'.$_SESSION['admin_directory'].'/admin/users/edit/?rid='.$_SESSION['user_id'].'" target="_blank">here</a>.</div>'; } ?>
