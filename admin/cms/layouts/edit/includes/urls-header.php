...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/edit/includes/urls-header.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/layouts/edit/includes/urls-header.php');
}
else
{
