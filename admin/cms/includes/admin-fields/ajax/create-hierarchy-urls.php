...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/ajax/create-hierarchy-urls.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/ajax/create-hierarchy-urls.php');
}
else
{
