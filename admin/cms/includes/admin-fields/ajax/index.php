...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/ajax/index.php'))
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/ajax/index.php');
}
else
{
}
