...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/admin-fields/modify.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/admin-fields/modify.php');
}
else
{
	//Auto loader - modify
	...
	if(is_dir($_SERVER['DOCUMENT_ROOT'].'/admin/cms/includes/admin-fields/modify')) 
	{
		$types_to_load[] = 'cms';
	}
	
	if(is_dir($_SERVER['DOCUMENT_ROOT'].'/admin/commerce/includes/admin-fields/modify')) 
	{
		$types_to_load[] = 'commerce';
	}
	
	if(is_dir($_SERVER['DOCUMENT_ROOT'].'/admin/erp/includes/admin-fields/modify'))
	{
		$types_to_load[] = 'erp';
	}
	
	if(is_dir($_SERVER['DOCUMENT_ROOT'].'/admin/ai/includes/admin-fields/modify')) 
	{
		$types_to_load[] = 'ai';
	}
