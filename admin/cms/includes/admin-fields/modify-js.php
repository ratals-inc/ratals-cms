...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/modify-js.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/modify-js.php');
}
else
{
	...
	if(is_dir(INSTALLATION_ROOT.'/admin/cms/includes/admin-fields/modify-js')) 
	{
		$types_to_load[] = 'cms'; 
	}
	
	if(is_dir(INSTALLATION_ROOT.'/admin/commerce/includes/admin-fields/modify-js')) 
	{
		$types_to_load[] = 'commerce';
	}
	
	if(is_dir(INSTALLATION_ROOT.'/admin/erp/includes/admin-fields/modify-js'))
	{
		$types_to_load[] = 'erp';
	}
	
	if(is_dir(INSTALLATION_ROOT.'/admin/ai/includes/admin-fields/modify-js')) 
	{
		$types_to_load[] = 'ai';
	}
