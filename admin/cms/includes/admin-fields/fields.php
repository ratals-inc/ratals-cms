...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/admin-fields/fields.php')) 
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/admin-fields/fields.php');
}
else
{
	...
	if(!empty($admin_fields))
	{
		foreach($admin_fields as $table_name => $table_column)
		{
			...
			{
				include($_SERVER['DOCUMENT_ROOT'].'/admin/cms/includes/admin-fields/field-sections.php');
				...
				{
					include_once $_SERVER['DOCUMENT_ROOT'].'/admin/cms/includes/custom-fields/fields.php';
				}
			}
		}
	}
