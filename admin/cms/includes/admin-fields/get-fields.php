...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/get-fields.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/includes/admin-fields/get-fields.php');
}
else
{
