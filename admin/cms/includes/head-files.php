...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/head-files.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/head-files.php');
}
else
{
...
<link rel="stylesheet" href="/sites/libraries/jquery-ui-1.14.1/jquery-ui.css">
<link rel="stylesheet" href="/<?php echo $_SESSION['admin_directory']; ?>/cms/includes/stylesheet.css">
...
<script src="/sites/libraries/jquery-ui-1.14.1/jquery-ui.js" nonce="<?php echo NONCE; ?>"></script>
