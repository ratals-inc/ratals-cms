...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/media-popup.php'))
{
	require_once($_SERVER['DOCUMENT_ROOT'].'/hooks/admin/cms/includes/media-popup.php');
}
else
{
?>
    ...
    $(document).on('click', '.selectMedia', function()
    {
        ...
        var addMedia = $("#selectedMediaId").val();
        var i = parseInt(addMedia) + 1;
            
        if(selected_media.includes("images"))
        {
            var html = '<li class="media" id="removeMultipleMedia_'+i+'"><i class="close removeMultipleMedia" data-click="'+i+'" title="Remove Media"><svg viewBox="0 0 512 512"><path d="M506 256A250 250 0 1 1 6 256 250 250 0 0 1 506 256M173 151A16 16 0 1 0 151 173L234 256 151 339A16 16 0 0 0 173 361L256 278 339 361A16 16 0 0 0 361 339L278 256 361 173A16 16 0 0 0 339 151L256 234Z"></path></svg></i><i class="move move-handle" aria-hidden="true" title="Sort Media"><svg viewBox="0 0 512 512"><path d="m245 7a16 16 0 0 1 22 0l63 63a16 16 0 0 1-22 22l-36-36v120a16 16 0 0 1-32 0v-120l-36 36a16 16 0 1 1-22-22zm11 312a16 16 0 0 1 16 16v120l36-36a16 16 0 0 1 22 22l-63 63a16 16 0 0 1-22 0l-63-63a16 16 0 0 1 22-22l36 36v-120a16 16 0 0 1 16-16m-249-52a16 16 0 0 1 0-22l63-63a16 16 0 1 1 22 22l-36 36h120a16 16 0 0 1 0 32h-120l36 36a16 16 0 0 1-22 22zm312-11a16 16 0 0 1 16-16h120l-36-36a16 16 0 0 1 22-22l63 63a16 16 0 0 1 0 22l-63 63a16 16 0 0 1-22-22l36-36h-120a16 16 0 0 1-16-16"></path></svg></i><img src="'+selected_media+'"><input name="'+columnNames.columnName+'['+columnNames.counter+'][]" type="hidden" value="'+id+'"><div class="text"><div class="tag"><input name="'+columnNames.columnName+'['+columnNames.counter+'][]" type="text" value="" placeholder="'+selected_tag+'"></div>Media ID: <a href="<?php echo $domain; ?>/<?php echo $_SESSION['admin_directory']; ?>/media/?textfield-id='+id+'" target="_blank">'+id+'</a></div></li>';
        }
        ...
        {
            var html = '<li class="media" id="removeMultipleMedia_'+i+'"><i class="close removeMultipleMedia" data-click="'+i+'" title="Remove Media"></i><i class="move move-handle" aria-hidden="true" title="Sort Media"><svg viewBox="0 0 512 512"><path d="m245 7a16 16 0 0 1 22 0l63 63a16 16 0 0 1-22 22l-36-36v120a16 16 0 0 1-32 0v-120l-36 36a16 16 0 1 1-22-22zm11 312a16 16 0 0 1 16 16v120l36-36a16 16 0 0 1 22 22l-63 63a16 16 0 0 1-22 0l-63-63a16 16 0 0 1 22-22l36 36v-120a16 16 0 0 1 16-16m-249-52a16 16 0 0 1 0-22l63-63a16 16 0 1 1 22 22l-36 36h120a16 16 0 0 1 0 32h-120l36 36a16 16 0 0 1-22 22zm312-11a16 16 0 0 1 16-16h120l-36-36a16 16 0 0 1 22-22l63 63a16 16 0 0 1 0 22l-63 63a16 16 0 0 1-22-22l36-36h-120a16 16 0 0 1-16-16"></path></svg></i><video controls="" preload="none" class="select-media-popup"><source src="'+selected_media+'" type="video/'+fileExtType+'"></video><input name="'+columnNames.columnName+'['+columnNames.counter+'][]" type="hidden" value="'+id+'"><div class="text"><div class="tag"><input name="'+columnNames.columnName+'['+columnNames.counter+'][]" type="text" value="" placeholder="'+selected_tag+'"></div>Media ID: <a href="<?php echo $domain; ?>/<?php echo $_SESSION['admin_directory']; ?>/media/?textfield-id='+id+'" target="_blank">'+id+'</a></div></li>';
        }
        //Video Embed
        else
        {
