...
?>
    <div class="editor-container">
        ...
        <div class="editor-styles-container">
            <div class="editor-styles">
                ...
                <!--<form>-->
                    ...
                    <div class="style-group display-grid">
                        <div class="heading">Grid Styling Options</div>
                        <div>
                    ...
                    <div class="style-group display-flex">
                        <div class="heading">Flex Styling Options</div>
                        <div>
                    ...
                    <div class="style-group">
                        ...
                        <div>
                            ...
                            <input name="table-border-thickness" id="table-border-thickness" type="text" value="0">
                        </div>
                        <div>
                            <label for="table-cell-padding">Cell Padding:</label>
                            <input name="table-cell-padding" id="table-cell-padding" type="text" value="0">
                        </div>
                        <div>
                        ...
                        <div>
                            <button type="button" id="table-merge-cells">Add Table</button>
                        </div>
                    </div>
                    <div class="style-group">
        ...
        <div class="editor-wrapper">
            <!-- Start Tools -->
            <div id="tools">
                <button type="button" id="editStyles">Edit Styles</button>
                <button type="button" id="undo">Undo</button>
                <button type="button" id="redo">Redo</button>
                <button type="button" id="strong">Bold</button>
                <button type="button" id="italic">Italic</button>
                <button type="button" id="underline">Underline</button>
                <button type="button" id="strike-through">Strike</button>
                ...
                <button type="button" id="insertLinkButton">Link</button>
                <button type="button" id="unlink">Unlink</button>
                <button type="button" id="ordered-list">Ordered List</button>
                <button type="button" id="unordered-list">Unordered List</button>
                <select id="element-type" name="element-type">
                    <option value="div">div</option>
                    <option value="span">span</option>
                    <option value="button">button</option>
                </select>
                <button type="button" id="addDivButton">Add Element</button>
                <button type="button" id="show-source">Source Code</button>
            </div>
            <!-- End Tools -->
            <!-- Start Editor -->
            <div id="editor" class="content-styles" contenteditable="true">
    ...
    <div id="source-code-popup">
        <div id="source-content">
            <h2>Source Code</h2>
            <textarea name="<?php echo $editor_name; ?>" id="source-code"><?php echo $editor_content; ?></textarea>
