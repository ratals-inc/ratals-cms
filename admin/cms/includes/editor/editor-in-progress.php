...
?>
        ...
        <div class="editor-styles-container">
            <div class="editor-styles">
                ...
                <form>
                    ...
                    <div class="style-group display-grid" id="displayGridArea" style="display: none"></div>
                    <div class="style-group display-flex" id="displayFlexArea" style="display: none"></div>
                    <div class="style-group display-flex" id="generalAlignArea" style="display: block">
    ...
    <!--                    <option value=""></option>-->
    <!--                    <option value="background-color: #000000">background-color: #000000 (Black)</option>-->
    <!--                    <option value="background-color: #ffffff">background-color: #ffffff (White)</option>-->
    <!--                    <option value="background-color: #ff0000">background-color: #ff0000 (Red)</option>-->
    <!--                    <option value="background-color: #4fc121">background-color: #4fc121 (Green)</option>-->
    <!--                    <option value="background-color: #fff900">background-color: #fff900 (Yellow)</option>-->
    <!--                    <option value="background-color: #3582d1">background-color: #3582d1 (Blue)</option>-->
    <!--                </select>-->
    <!--                </div>-->
                    <div>
                        <label for="background-color">Background Color:</label>
                    ...
                    <div class="style-group">
                        ...
                        <div>
                        <label for="border">Border - All Sides (Thickness):</label>
                        ...
                        <div>
                        <label for="border-top">Border Top (Thickness):</label>
                        <select id="border-top" name="border-top">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-right">Border Right (Thickness):</label>
                        <select id="border-right" name="border-right">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-bottom">Border Bottom (Thickness):</label>
                        <select id="border-bottom" name="border-bottom">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-left">Border Left (Thickness):</label>
                        <select id="border-left" name="border-left">
                            <option value=""></option>
                        ...
                        <select id="border-color" name="border-color">
                            <option value=""></option>
                            <option value="border-color: #000000">border-color: #000000 (Black)</option>
                            <option value="border-color: #ffffff">border-color: #ffffff (White)</option>
                            <option value="border-color: #ff0000">border-color: #ff0000 (Red)</option>
                            <option value="border-color: #4fc121">border-color: #4fc121 (Green)</option>
                            <option value="border-color: #fff900">border-color: #fff900 (Yellow)</option>
                            <option value="border-color: #3582d1">border-color: #3582d1 (Blue)</option>
                        </select>
                        </div>
                    </div>
                    <div class="style-group">
                        ...
                        <div>
                        <label for="border-radius">Border Radius (All Sides):</label>
                        <select id="border-radius" name="border-radius">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-top-left-radius">Border Top Left Radius:</label>
                        <select id="border-top-left-radius" name="border-top-left-radius">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-top-right-radius">Border Top Right Radius:</label>
                        <select id="border-top-right-radius" name="border-top-right-radius">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-bottom-left-radius">Border Bottom Left Radius:</label>
                        <select id="border-bottom-left-radius" name="border-bottom-left-radius">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="border-bottom-right-radius">Border Bottom Right Radius:</label>
                        <select id="border-bottom-right-radius" name="border-bottom-right-radius">
                            <option value=""></option>
    ...
    <!--                        <option value=""></option>-->
    <!--                        <option value="color: #000000">color: #000000 (Black)</option>-->
    <!--                        <option value="color: #ffffff">color: #ffffff (White)</option>-->
    <!--                        <option value="color: #ff0000">color: #ff0000 (Red)</option>-->
    <!--                        <option value="color: #4fc121">color: #4fc121 (Green)</option>-->
    <!--                        <option value="color: #fff900">color: #fff900 (Yellow)</option>-->
    <!--                        <option value="color: #3582d1">color: #3582d1 (Blue)</option>-->
    <!--                    </select>-->
                        </div>
                    </div>
                    <div>
                    ...
                    <select id="max-height" name="max-height">
                        <option value=""></option>
                    ...
                    <select id="list-style-type" name="list-style-type">
                        <option value=""></option>
                    ...
                    <div class="style-group">
                        ...
                        <div>
                        <label for="margin">Margin (All Sides):</label>
                        ...
                        <select id="margin-top" name="margin-top">
                            <option value=""></option>
                        ...
                        <select id="margin-right" name="margin-right">
                            <option value=""></option>
                        ...
                        <select id="margin-bottom" name="margin-bottom">
                            <option value=""></option>
                        ...
                        <select id="margin-left" name="margin-left">
                            <option value=""></option>
                    ...
                    <select id="object-fit" name="object-fit">
                        <option value=""></option>
                    ...
                    <div class="style-group">
                        ...
                        <div>
                        <label for="overflow">Overflow (Horizontal & Vertical):</label>
                        ...
                        <div>
                        <label for="overflow-x">Overflow X (Horizontal):</label>
                        <select id="overflow-x" name="overflow-x">
                            <option value=""></option>
                        ...
                        <div>
                        <label for="overflow">Overflow Y (Vertical):</label>
                        <select id="overflow" name="overflow">
                            <option value=""></option>
                    ...
                    <div class="style-group">
                        ...
                        <div>
                        <label for="padding">Padding (All Sides):</label>
                        ...
                        <select id="padding-top" name="padding-top">
                            <option value=""></option>
                        ...
                        <select id="padding-right" name="padding-right">
                            <option value=""></option>
                        ...
                        <select id="padding-bottom" name="padding-bottom">
                            <option value=""></option>
                        ...
                        <select id="padding-left" name="padding-left">
                            <option value=""></option>
                    ...
                    <select id="scroll-behavior" name="scroll-behavior">
                        <option value=""></option>
                    ...
                    <div class="style-group">
                        ...
                        <div>
                            ...
                            <input name="table-rows" id="table-rows" type="text" value="3">
                        </div>
                        <div>
                            <label for="table-columns">Columns:</label>
                            <input name="table-columns" id="table-columns" type="text" value="3">
                        </div>
                        <div>
                            <label for="table-width">Width: (%)</label>
                            <input name="table-width" id="table-width" type="text" value="100">
                        </div>
                        <div>
                            <label for="table-border-thickness">Border Thickness:</label>
                            <input name="table-border-thickness" id="table-border-thickness" type="text" value="1">
                        </div>
                        <div>
                            <label for="table-cell-padding">Cell Padding:</label>
                            <input name="table-cell-padding" id="table-cell-padding" type="text" value="5">
                        </div>
                        <div>
                            <label for="table-cell-spacing">Cell Spacing:</label>
                            <input name="table-cell-spacing" id="table-cell-spacing" type="text" value="0">
                        </div>
                        <div>
                            <button type="button" id="create-table">Add Table</button>
                        </div>
                    </div>
                    <div class="style-group">
                        <div class="heading">Table Options (Edit)</div>
                        <div>
                            <button type="button" id="table-merge-cells">Merge Cells</button>
                        </div>
                        <div>
                            <button type="button" id="table-split-cell">Split Cell</button>
                        </div>
                        <div>
                            <button type="button" id="table-insert-row-before">Insert Row Before</button>
                        </div>
                        <div>
                            <button type="button" id="table-insert-row-after">Insert Row After</button>
                        </div>
                        <div>
                            <button type="button" id="table-insert-column-before">Insert Column Before</button>
                        </div>
                        <div>
                            <button type="button" id="table-insert-column-after">Insert Column After</button>
                        </div>
                    </div>
                    <div>
                    ...
                    <select id="text-decoration" name="text-decoration">
                        <option value=""></option>
                    ...
                    <div>
                    <label for="vertical-align">Vertical Align (vertical-align):</label>
                    <select id="vertical-align" name="vertical-align">
                        <option value=""></option>
                    ...
                    <select id="white-space" name="white-space">
                        <option value=""></option>
                    ...
                    <select id="max-width" name="max-width">
                        <option value=""></option>
                    ...
                    <select id="z-index" name="z-index">
                        <option value=""></option>
        ...
        <div class="editor-wrapper">
            ...
            <div id="tools">
                ...
                <button type="button" class="addDivButton">Add Element</button>
                <button type="button" class="show-source">Source Code</button>
            </div>
            <!-- End Tools -->
    
            <!-- Start Editor 1 -->
            <div id="editor1" class="content-styles editor-parent" contenteditable="true">
                <style>
                    .content-0 { display: grid !important; grid-template-columns: 300px auto 300px !important; column-gap: 5px !important; row-gap: 5px !important; }
                    .content-1 { grid-column: 1 / -1 !important; }
                    .content-2 { grid-column: 1 / -1 !important; }
                </style>
                <div class="content-0">
                    <div class="content-1">
                        <span class="italic-text bold-text underline-text">CompanyName</span>
                    </div>
                    <div>
                        <ul class="margin-0 padding-0">
                            <li class="margin-0 padding-0"> <span class="bold-text">fdgddgdsfdsf</span> </li>
                            <li>s<span class="bold-text italic-text">dfdsfsdf</span>d<span class="bold-text">ssdfds</span>dsf</li>
                            <li>asdsadsadasd</li>
                            <li>asdsadsad</li>
                        </ul>
                    </div>
                    <div>
                        <h1 class="font-size-40">My Editor No 1</h1>
                    ...
                    <div class="content-2">
                        <a href="urlId(34);">dfdsfds</a> - <a href="urlId(54);">dsfdsfsdf</a> - <a href="urlId(88);">dsfsdfsdf</a> - <a href="urlId(89);">dsfsdfdsf</a> - <a href="urlId(56);">sdfsddsf sdfdsfd sdfsdfsd</a>
                    </div>
                </div>
            </div>
            <!-- End Editor 1 -->
    ...
    <div id="link-manager" class="link-manager-popup-wrapper link-manager-hide">
        <div class="link-manager">
            ...
            <div class="link-manager-buttons">
                <button type="button" id="insertLinkBtn" class="insert-btn">Insert Link</button>
