...
if(file_exists(INSTALLATION_ROOT.'/hooks/admin/cms/includes/custom-fields/validation.php')) 
{
	require_once(INSTALLATION_ROOT.'/hooks/admin/cms/includes/custom-fields/validation.php');
}
else
{
