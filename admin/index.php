...
else
{
	...
	elseif(isset($_SESSION['user_id']))
	{
		...
		if(!empty($admin_user_row)) 
		{
			...
			$_SESSION['user_email'] = $admin_user_row['email'];
			$_SESSION['user_email_signiture'] = $admin_user_row['email_signiture'];
			$_SESSION['user_email_cc'] = $admin_user_row['email_cc'];
			$_SESSION['user_email_bcc'] = $admin_user_row['email_bcc'];
			$_SESSION['user_email_server_url'] = $admin_user_row['email_server_url'];
			$_SESSION['user_email_server_port'] = $admin_user_row['email_server_port'];
			$_SESSION['user_email_username'] = $admin_user_row['email_username'];
			$_SESSION['user_email_password'] = $admin_user_row['email_password'];
